		...
		while ($row = mysqli_fetch_array($result, 1)) {
			...
			echo'
				...
				<div style="cursor:default;padding:3px;style="font-size:25px;line-height:25px;">
					'.$row['time_value'].'
					<span class="c_r" id="time-'.$row['time_id'].'" onclick="removeTimeTag(this)" style="cursor:pointer;float:right;font-size:25px;line-height:15px;padding-left:-20px;padding-right:10px;font-weight:900;">
						&times
					</span>
				</div>
